...
for episode in tqdm(range(EPISODE)):
    ...
    while True:
        ...
        # print('Player 1 Reward : {}'.format(reward))
        RL_player_1.update(state, next_state, RL_player_1_action, reward, done)
        # print(RL_player_1.value_table)
        if done == 1: break
        ...
        # print('Player 2 Reward : {}'.format(reward))
        RL_player_2.update(state, next_state, RL_player_2_action, reward, done)
